...
namespace NuGet.Packaging
{
    ...
    {
        public string PackageExtractionId => (string)base[nameof(PackageExtractionId)];
            ...
            base(EventName, new Dictionary<string, object>
                {
                    ...
                    { nameof(PackageExtractionId), packageExtractionId.ToString() },
